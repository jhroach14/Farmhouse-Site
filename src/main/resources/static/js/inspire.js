app.controller('inspireCtrl', ['$scope', '$http', //scope = model for angular, http = object used for http transactions
    function($scope, $http) {
        ...
        $scope.loadEditData = function () {
            url = "http://"+window.location.hostname+":8080/admin/inspireInfo";
        ...
        modifyPost = function (id) {
            url = "http://"+window.location.hostname+":8080/admin/getPost?post="+id;
            $http.get(url).success(
                function (response) {
        ...
        deletePost = function (id) {
            var url = "http://"+window.location.hostname+":8080/admin/deletePost?post="+id;
        ...
        $scope.inspireEdit = function () {
            var url = "http://"+window.location.hostname+":8080/admin/inspireEdit";
            var result = confirm("Are you sure? Any changes you have made will go live on the site.");
            if(result){
        ...
        $scope.savePost = function () {
            var url = "http://"+window.location.hostname+":8080/admin/postEdit";
            var result = confirm("Are you sure? Any changes you have made will go live on the site.");
            if(result){
        ...
        $scope.saveNewPost = function () {
            var url = "http://"+window.location.hostname+":8080/admin/newPost";
            var result = confirm("Are you sure? Any changes you have made will go live on the site.");
            if(result){
